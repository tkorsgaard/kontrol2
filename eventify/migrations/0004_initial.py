...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('eventify_guest', (
            ...
            ('wish', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eventify.Wish'], null=True, blank=True)),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eventify.Event'], null=True, blank=True)),
        ))
