...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('eventify_guest', 'event',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['eventify.Event'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Guest.event'
        db.delete_column('eventify_guest', 'event_id')
    ...
    models = {
        ...
        'eventify.guest': {
            ...
            'event': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['eventify.Event']", 'null': 'True'}),
